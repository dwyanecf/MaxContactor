...
public class ContactsProvider extends ContentProvider {
    ...
    private FileOp dbHelper;
    private SQLiteDatabase contactsDB;

    public static final String AUTHORITY = "com.dwyanecf.provider.contact";
    ...
    public boolean onCreate() {
        dbHelper = new FileOp(getContext());
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)) {
            case CONTACTS:
                return "vnd.android.cursor.dir/vnd.dwyanecf.MaxContactor";
            case CONTACT_ID:
                return "vnd.android.cursor.item/vnd.dwyanecf.MaxContactor";
            default:
